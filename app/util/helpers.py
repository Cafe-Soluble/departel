# Fonction pour convertir un numéro de téléphone en liste de départements associés
def numero_vers_departements(numero_telephone):
    DEPARTEMENTS = {
        '01': 'Ain', 
        '02': 'Aisne', 
        '03': 'Allier', 
    ...
    for i in range(0, len(numero_telephone)-1, 2):
